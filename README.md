...
Check out the [Picovoice demo for PSoC6](https://github.com/Picovoice/picovoice-demo-psoc6) to see what it looks like to use Picovoice in an embedded project!
